      ...
      <div>
        ...
        <el-form label-width="80px">
          ...
          <el-form-item label="私钥内容">
            <el-input v-model="kvs[0].value" placeholder="-----BEGIN RSA PRIVATE KEY-----开头的内容" type="textarea" :row="2" />
            <a href="javascript:" class="file">从文件导入
              <input ref="filekey" type="file" accept=".txt,.pem,.key,.pkey" @change="()=>fileChange('filekey')"></input>
            </a>
          </el-form-item>
          ...
          <el-form-item label="证书内容">
            <el-input v-model="kvs[1].value" placeholder="-----BEGIN CERTIFICATE-----开头的内容" type="textarea" :row="2" />
            <a href="javascript:" class="file">从文件导入
              <input ref="filecrt" type="file" accept=".txt,.pem,.crt,.cert" @change="()=>fileChange('filecrt')"></input>
            </a>
          </el-form-item>
